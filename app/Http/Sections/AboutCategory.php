 ...
 * Class AboutCategory
 *
 * @property \App\Models\AboutCategory $model
 *
 * @see https://sleepingowladmin.ru/#/ru/model_configuration_section
 */
class AboutCategory extends Section implements Initializable
{
    /**
     * @var bool
     */
    ...
    public function onEdit($id = null, $payload = [])
    {
        $form = AdminForm::card()->addBody([
            ...
            AdminFormElement::select('is_fixed', 'Вывести на главную', [
                    true => 'да',
                    false => 'нет'
                ])
                ->setDefaultValue(0),
