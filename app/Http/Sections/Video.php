        ...
        $form = AdminForm::card()->addBody([
            ...
            AdminFormElement::image('thumbnail', 'Обложка')
                ->setUploadPath(function($file) {
                    return PathSaveClass::getUploadPath('video','images'); 
                }),
            AdminFormElement::files('files', 'Видео файлы')
                ->setUploadPath(function($file) {
                    return PathSaveClass::getUploadPath('video','files'); 
                }),
